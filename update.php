...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err) && empty($gender_err) && empty($designation_err)){
        ...
        $sql = "UPDATE employees SET name=:name, address=:address, salary=:salary, gender=:gender, designation=:designation WHERE id=:id";
                          ...
                          <span>Please Select Designation</Span>
                            <select name="designation" class="dropdown">
                              <option value="">-select-</option>
                                  <option  <?php if ( $designation=="Senior"){ echo "selected";}?> value="Senior">Senior</option>
                                  <option  <?php if ($designation=="Junior") echo "selected";?> value="Junior">Junior</option>
                                  <option  <?php if ( $designation=="Intern") echo "selected";?> value="Intern">Intern</option>
                                </select>
